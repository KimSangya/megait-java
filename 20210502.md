...
### 중 4(문제를 이해할수가 없어서 생략했습니다.)

### 중 5(이건 내일까지 한번 풀어보겠습니다. 풀게된다면 다시 카톡으로 연락드리겠습니다!)
...
public class Homework05 {
	public static void main(String[] args) {
		...
		System.out.println("자리수 6개를 입력해주세요. 1~45중 하나를 선택해서 넣으셔야합니다.");
		for(int i = 0; i < 6; ++i) {
			num = sc.nextInt();
			hum[i] = num;
			
			if(num<1 || num>45) {
			System.out.println("1보다 작거나 45보다 큰 수입니다. 다른걸 입력해주세요.");
				num = sc.nextInt();
			}		
		...
		System.out.println("번호중 " + count+"개의 번호를 맞추셨네요!");
	}
